...
switch ($uri) {
    ...
    case '/compra/adicionar':
        $controller = new \app\controllers\CompraController();
        $controller->formCreate();
        break;

    case (preg_match('/\/compra\/editar\\/(\d+)/', $uri, $matches) ? true : false):
        $controller = new \app\controllers\CompraController();
        $controller->formEdit((int)$matches[1]);
        break;
    ...
    case (preg_match('/\/compra\/deletar\/(\d+)/', $uri, $matches) ? true : false):
        $controller = new \app\controllers\CompraController();
        $controller->delete((int)$matches[1]);
        break;
    //-------------------------------------------------------------------------------------------
    ...
    //Parcela
    case '/parcela':
        $controller = new \app\controllers\ParcelaController();
        $controller->index();
        break;
    ...
    case (preg_match('/\/parcela\/editar\\/(\d+)/', $uri, $matches) ? true : false):
        $controller = new \app\controllers\ParcelaController();
        $controller->formEdit((int)$matches[1]);
        break;

    case (preg_match('/\/parcela\/deletar\/(\d+)/', $uri, $matches) ? true : false):
        $controller = new \app\controllers\ParcelaController();
        $controller->delete((int)$matches[1]);
        break;
    //-------------------------------------------------------------------------------------------
